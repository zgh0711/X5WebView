...
public class TitleView extends LinearLayout implements OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        left_tv = mLinearLayout.findViewById(R.id.tv_left_titleView);
        left_tv1 = mLinearLayout.findViewById(R.id.tv_leftBadge_titleView);
        center_tv = mLinearLayout.findViewById(R.id.tv_center_titleView);
        right_tv = mLinearLayout.findViewById(R.id.tv_right_titleView);
        right_tv1 = mLinearLayout.findViewById(R.id.tv_rightBadge_titleView);
        tabLayout = mLinearLayout.findViewById(R.id.tabLayout_titleView);
        left_ibtn = mLinearLayout.findViewById(R.id.ibtn_left_titleView);
        right_ibtn = mLinearLayout.findViewById(R.id.ibtn_right_titleView);
        rightSecond_ibtn = mLinearLayout.findViewById(R.id.ibtn_right_second);
        center_ibtn = mLinearLayout.findViewById(R.id.ibtn_center);
