...
public class ImageManager {
    ...
    public void withNoDefault(Context context, @NonNull String imageUrl, @NonNull
            ImageView imageView) {
        Glide.with(context)
             .load(imageUrl)
             .dontAnimate()
    ...
    public void withImage(Context context, @NonNull String imageUrl, @DrawableRes int resId, @NonNull
            ImageView imageView) {
        Glide.with(context)
             .load(imageUrl)
             .dontAnimate()
    ...
    public void withImage(Context context, @NonNull File file, @DrawableRes int resId, @NonNull
            ImageView imageView) {
        Glide.with(context)
             .load(file)
             .dontAnimate()
    ...
    public void withImage(Context context, @DrawableRes int res, @DrawableRes int resId, @NonNull
            ImageView imageView) {
        Glide.with(context)
             .load(res)
             .dontAnimate()
